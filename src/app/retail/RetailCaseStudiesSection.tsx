...
const caseStudies: RetailCaseStudy[] = [
  {
    id: "otobi",
    logoText: "otobi",
...
export default function RetailCaseStudiesSection() {
  const [active, setActive] = useState<RetailCaseStudy>(caseStudies[0]);
      ...
      <div className="mx-auto max-w-[1240px]">
        ...
        <div className="mt-[74px] flex flex-wrap gap-5">
          {caseStudies.map((item) => {
            ...
            return (
              ...
              >
                <span
                  className={`text-center text-[34px] font-black lowercase leading-none tracking-[-0.08em] ${item.logoColor}`}
                >
                  {item.logoText}
                </span>
              </button>
        ...
        <div className="mt-[44px] grid grid-cols-1 items-center gap-[78px] lg:grid-cols-[0.9fr_1fr]">
          ...
          <div className="group relative overflow-hidden rounded-[8px] bg-[#f4f8fc] shadow-[0_22px_70px_rgba(17,30,64,0.08)]">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-[#4c3f86]/45 via-[#4c3f86]/20 to-transparent" />
