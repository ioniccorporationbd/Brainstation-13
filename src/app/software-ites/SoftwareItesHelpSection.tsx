...
const helpItems: HelpItem[] = [
  ...
  },
  {
    ...
    description:
      "We help IT & software businesses adopt analytical tools and Business Intelligence solutions to help monitor and strategize operations effectively.",
    icon: BrainCircuit,
  },
  {
    title: "ERP Solutions",
  ...
  },
  {
    ...
    description:
      "Our cloud computing services help IT & software businesses to adopt flexible computing resources and data collection.",
    icon: Laptop,
  },
  {
    title: "AR/VR Applications",
    description:
      "Our AR/VR experts help IT & software businesses to build engaging solutions to help them build engaging campaigns for their causes.",
    icon: Cloud,
  },
  {
    title: "Chatbot",
    description:
      "We offer AI powered chatbots for IT & software businesses to bolster their customer services with the latest innovations.",
    icon: Bot,
  },
];

export default function SoftwareItesHelpSection() {
  return (
