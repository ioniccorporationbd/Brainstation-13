export default function AutomotiveHeroSection() {
  return (
      ...
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mx-auto max-w-[920px] text-center">
          ...
          <p className="mx-auto mt-7 max-w-[920px] text-[18px] font-medium leading-[1.45] tracking-[-0.035em] text-[#42637a] md:text-[22px]">
            We help automobile manufacturers with process automation and customer
            service solutions- for automobile manufacturers to build their
            brands, have an efficient enterprise, and build engaging customer
            experiences.
          </p>
        </div>
        ...
        <div className="mx-auto mt-[82px] max-w-[1220px]">
          <div className="group overflow-hidden rounded-[8px] bg-[#111E40] shadow-[0_22px_70px_rgba(17,30,64,0.10)]">
            <img
              ...
              alt="Modern automotive sports car"
