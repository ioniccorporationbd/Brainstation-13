...
const successStories: SuccessStory[] = [
  ...
  {
    quote:
      "Provided enterprise consulting support for architecture modernization, cloud readiness, and delivery governance.",
    logo: "telenor",
  },
  {
    quote:
      "Helped teams improve product engineering processes, reduce technical debt, and scale delivery with confidence.",
    logo: "Sanofi",
  },
  {
    quote:
      "Delivered technology advisory, system integration planning, and roadmap support for large-scale digital initiatives.",
    logo: "VEON",
  },
  {
    quote:
      "Supported platform modernization through technical audits, architecture reviews, and implementation guidance.",
    logo: "Robi",
  },
];
...
export default function TechnologyConsultingSuccessStoriesSection() {
  return (
      ...
      <div className="mx-auto grid max-w-[1320px] grid-cols-1 gap-12 lg:grid-cols-[0.42fr_1fr] lg:items-start">
        ...
        <div className="relative min-w-0 overflow-hidden">
          ...
          <Swiper
            ...
            className="technology-success-stories-swiper !overflow-visible"
          >
