...
const caseStudies: NonProfitCaseStudy[] = [
  {
    id: "otobi",
    logoText: "otobi",
    logoClassName:
      "text-[34px] font-black lowercase leading-none tracking-[-0.08em] text-black",
    category: "ERP HRMS Solution",
    title: "OTOBI",
    image:
    ...
    stats: [
      {
        value: "90%",
        label: "Fragmented HR Data Management",
      },
      {
        value: "85%",
        label: "Inaccurate & Manual Attendance Records",
      },
    ],
    href: "/case-studies/otobi",
  },
];

export default function NonProfitCaseStudiesSection() {
  const [active, setActive] = useState<NonProfitCaseStudy>(caseStudies[0]);
      ...
      <div className="mx-auto max-w-[1240px]">
        ...
        <div className="mt-[44px] grid grid-cols-1 items-center gap-[78px] lg:grid-cols-[0.9fr_1fr]">
          ...
          <div className="group relative overflow-hidden rounded-[8px] bg-[#f4f8fc] shadow-[0_22px_70px_rgba(17,30,64,0.08)]">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-[#4c3f86]/50 via-[#4c3f86]/20 to-transparent" />

            <div className="absolute bottom-8 left-8">
              <p className="text-[32px] font-black uppercase leading-none tracking-[-0.04em] text-white md:text-[42px]">
                ERP Solutions
              </p>
            </div>
          </div>
